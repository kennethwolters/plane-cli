...
func printUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  plane-cli work list --project <project> [--state-group <group>] [--fields <csv>] [--description-excerpt <n>] [--include-comments-latest <n>] [--limit <n>] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work get <PROJECT-123> [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work create --project <project> --title <title> [--description-html <html>|--description-file <path>|--description-md-file <path>] [--priority <priority>] [--dedupe-query <query>] [--dry-run|--apply] [--verify] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work edit <PROJECT-123> [--title <title>] [--description-html <html>|--description-file <path>|--append-description-html <html>] [--priority <priority>] [--labels-add <csv>] [--labels-remove <csv>] [--assignees-add <csv>] [--assignees-remove <csv>] [--dry-run|--apply] [--verify] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work move <PROJECT-123> --state <state> [--dry-run|--apply] [--verify] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work comment <PROJECT-123> (--html <html>|--html-file <path>|--md-file <path>) [--dry-run|--apply] [--verify] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work comments <PROJECT-123> [--limit <n>] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work batch edit|comment --file <json> [--dry-run|--apply] [--verify] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work children <PROJECT-123> [--limit <n>] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work parent set <CHILD-123> <PARENT-123> [--dry-run|--apply] [--verify] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work parent clear <CHILD-123> [--dry-run|--apply] [--verify] [--format text|json]")
	fmt.Fprintln(w, "  plane-cli work relation add|remove <PROJECT-123> --blocks <PROJECT-456> [--dry-run|--apply] [--verify] [--format text|json]")
	...
	fmt.Fprintln(w, "  plane-cli search <query> [--project <project>] [--include-comments] [--max-results <n>] [--format text|json]")
}
